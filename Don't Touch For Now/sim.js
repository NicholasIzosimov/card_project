/* Weightless Deck — the simulation.
   ...
   double-clicking the HTML (no server, no build). Its top-level
   declarations are intentionally global: the page script reads and
   writes `selected`, `time` and `contactCount` directly, exactly as
   it did when all of this lived in one closure. That goes away when
   this becomes a real module in the TypeScript pass.
